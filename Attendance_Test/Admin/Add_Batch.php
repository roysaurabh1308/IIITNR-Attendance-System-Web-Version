...
<?php
	...
	if(isset($_POST['Go']))
	{
		...
		/*$already=$database->getReference('BatchName')->getChildKeys();
		...
		$sv=[$_POST['bname'] => ['batch' => $_POST['bname']]];
		$database->getReference('BatchName')->update($sv);
...
<input type="text" name="bname" placeholder="Batch Name" required>
