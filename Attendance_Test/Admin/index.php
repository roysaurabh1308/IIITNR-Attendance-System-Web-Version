                            ...
                            <div class="classynav">
                                <ul id="nav">
									...
									<li><a >Faculty Section</a>
                                        <ul class="dropdown">
                                            <li><a href="./Add_Faculty.php">Create Faculty Ac.</a></li>
                                            <li><a href="./Remove_Faculty.php">Delete Faculty Ac.</a></li>
									...
									<li><a >Student Section</a>
                                        <ul class="dropdown">
											...
											<li><a href="./Add_Batch.php">Create New Batch</a></li>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                <h2 data-animation="bounceInDown" data-delay="900ms">Hello, <br>Mr.Admin</h2>
                                <p data-animation="bounceInDown" data-delay="500ms">Make things easier to Manage</p>
                                <div class="hero-btn-group" data-animation="bounceInDown" data-delay="100ms">
								<form action="#" method="POST">
									<button name="lo" class="btn alime-btn mb-3 mb-sm-0 mr-4" onclick="this.form.submit();">Don't forget to signout</button>
									</form>
                ...
                <div class="col-12">
                    <div class="footer-content d-flex align-items-center justify-content-between">
                        ...
                        <div class="copywrite-text">
                            <p>
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Developerdesk9 </i> @<a href="#" target="_blank">Attendance Register</a>
