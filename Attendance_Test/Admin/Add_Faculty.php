...
<?php
	...
	if(isset($_POST['Go']))
	{
		...
		$c=0;
		$em=$_POST['uname']."@iiitnr.edu.in";
		
		try {
				$user = $auth->getUserByEmail($em);
		...
		if($c==1)
		{
			...
			$database->getReference('Faculty')->getChild($_POST['uname'])->set($dets);
			echo "<script>document.getElementById('load').innerHTML=''</script>";
...
<input type="text" name="fname" placeholder="FacultyName" required>
<p>Enter User Name</p>
<input type="text" name="uname" placeholder="UserName" required>
<p>Enter Password</p>
<input type="password" name="pass" placeholder="Password" minlength="6" required>
